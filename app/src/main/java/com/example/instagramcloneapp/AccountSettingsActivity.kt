...
class AccountSettingsActivity : AppCompatActivity() {
    ...
    private fun updateUserInfoOnly() {
        when {
            ...
            bio_profile_frag.text.toString() == "" -> {
                Toast.makeText(this,"Please write yourt bio .",Toast.LENGTH_LONG).show()
            }
            else -> {
                ...
                Toast.makeText(this,"Account Information has benn updated successfully",Toast.LENGTH_LONG).show()
    ...
    private fun uploadImageAndUpdateInfo() {
        ...
        when {
            full_name_profile_frag.text.toString() == "" -> { Toast.makeText(this,"Please write fullname .",Toast.LENGTH_LONG).show() }
            username_profile_frag.text.toString() == "" -> { Toast.makeText(this,"Please write username .",Toast.LENGTH_LONG).show() }
            bio_profile_frag.text.toString() == "" -> { Toast.makeText(this,"Please write yourt bio .",Toast.LENGTH_LONG).show() }
